...
export const products: readonly Product[] = [
  ...
  },
  {
    ...
    image: '/products/cmp-200/studio-angle-v1.png',
  ...
  },
  {
    ...
    image: '/products/ts200-series/studio-angle-v1.png',
  ...
  { slug: 'ai-35', name: 'AI-35', family: 'Attendance', description: 'Face-recognition terminal for attendance and controlled workplace access.', image: '/products/ai-35/brochure-preview.png', images: ['/products/ai-35/brochure-preview.png'], authentication: 'Face', application: 'Attendance & access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/ai-35.pdf' },
  { slug: 'sf-1000', name: 'SF-1000', family: 'Access control', description: 'Fingerprint and card access-control terminal for secure workplace entry.', image: '/products/sf-1000/brochure-preview.png', images: ['/products/sf-1000/brochure-preview.png'], authentication: 'Fingerprint', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/sf-1000.pdf' },
  { slug: 'ai-15l', name: 'AI-15L', family: 'Attendance', description: 'Face and fingerprint recognition terminal for attendance and access workflows.', image: '/products/ai-15l/brochure-preview.png', images: ['/products/ai-15l/brochure-preview.png'], authentication: 'Face', application: 'Attendance & access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/ai-15l.pdf' },
  { slug: 'ai-70', name: 'AI-70', family: 'Attendance', description: 'AI biometric access-control and time-attendance terminal.', image: '/products/ai-70/brochure-preview.png', images: ['/products/ai-70/brochure-preview.png'], authentication: 'Face', application: 'Attendance & access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/ai-70.pdf' },
  { slug: 'bio-70', name: 'Bio 70', family: 'Attendance', description: 'Biometric terminal for face, fingerprint, and card-based workforce records.', image: '/products/bio-70/brochure-preview.png', images: ['/products/bio-70/brochure-preview.png'], authentication: 'Biometric', application: 'Attendance & access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/bio-70.pdf' },
  { slug: 'f-12-slave', name: 'F-12 Slave', family: 'Access control', description: 'RS485 fingerprint reader for connected biometric access systems.', image: '/products/f-12-slave/brochure-preview.png', images: ['/products/f-12-slave/brochure-preview.png'], authentication: 'Fingerprint', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/f-12-slave.pdf' },
  { slug: '20k-fp', name: '20K FP', family: 'Attendance', description: 'Fingerprint workforce terminal for attendance and access operations.', image: '/products/20k-fp/brochure-preview.png', images: ['/products/20k-fp/brochure-preview.png'], authentication: 'Fingerprint', application: 'Attendance & access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/20k-fp.pdf' },
  { slug: 'fp-padlock', name: 'FP Padlock', family: 'Access control', description: 'Fingerprint-enabled padlock for practical portable access control.', image: '/products/fp-padlock/brochure-preview.png', images: ['/products/fp-padlock/brochure-preview.png'], authentication: 'Fingerprint', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/fp-padlock.pdf' },
  { slug: 'door-interlock-system', name: 'Door Interlock System', family: 'Access control', description: 'Door interlock system for controlled movement between secured areas.', image: '/products/door-interlock-system/brochure-preview.png', images: ['/products/door-interlock-system/brochure-preview.png'], authentication: 'Connected access system', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/door-interlock-system.pdf' },
  { slug: 'door-interlock-card-mb01', name: 'Door Interlock Card MB01', family: 'Access control', description: '12V door-interlock control card for managed access installations.', image: '/products/door-interlock-card-mb01/brochure-preview.png', images: ['/products/door-interlock-card-mb01/brochure-preview.png'], authentication: 'Connected controller', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/door-interlock-card-mb01.pdf' },
  { slug: 'em-lock-600lbs', name: 'EM Lock 600LBS', family: 'Access control', description: 'Electromagnetic lock for controlled door access.', image: '/products/em-lock-600lbs/brochure-preview.png', images: ['/products/em-lock-600lbs/brochure-preview.png'], authentication: 'Connected access system', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/em-lock-600lbs.pdf' },
  { slug: 'ines33-exit-switch', name: 'INES33 Exit Switch', family: 'Access control', description: 'Door-release exit switch for controlled access points.', image: '/products/ines33-exit-switch/brochure-preview.png', images: ['/products/ines33-exit-switch/brochure-preview.png'], authentication: 'Connected access system', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/ines33-exit-switch.pdf' },
  { slug: 'innte33-no-touch-switch', name: 'INNTE33 No Touch Switch', family: 'Access control', description: 'No-touch exit switch for hygienic door-release operation.', image: '/products/innte33-no-touch-switch/brochure-preview.png', images: ['/products/innte33-no-touch-switch/brochure-preview.png'], authentication: 'Connected access system', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/innte33-no-touch-switch.pdf' },
  { slug: 'tripod-barrier-heavy', name: 'Tripod Barrier Heavy', family: 'Entrance management', description: 'Heavy-duty tripod barrier for orderly pedestrian entry.', image: '/products/tripod-barrier-heavy/brochure-preview.png', images: ['/products/tripod-barrier-heavy/brochure-preview.png'], authentication: 'Connected access system', application: 'Pedestrian entry', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/tripod-barrier-heavy.pdf' },
  { slug: 'surface-bolt-lock', name: 'Surface Bolt Lock', family: 'Access control', description: 'Surface electric bolt lock for secure controlled doors.', image: '/products/surface-bolt-lock/brochure-preview.png', images: ['/products/surface-bolt-lock/brochure-preview.png'], authentication: 'Connected access system', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/surface-bolt-lock.pdf' },
  { slug: 'face-ai-80-pro', name: 'Face AI-80 Pro', family: 'Attendance', description: 'High-capacity facial-recognition terminal for access and attendance.', image: '/products/face-ai-80-pro/brochure-preview.png', images: ['/products/face-ai-80-pro/brochure-preview.png'], authentication: 'Face', application: 'Attendance & access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/face-ai-80-pro.pdf' },
  { slug: 'f1000-series-flap-barrier', name: 'IND F1000 Series', family: 'Entrance management', description: 'High-efficiency flap barrier turnstile for high-traffic indoor and outdoor access points.', image: '/products/f1000-series-flap-barrier/brochure-preview.png', images: ['/products/f1000-series-flap-barrier/brochure-preview.png'], authentication: 'Connected access system', application: 'Pedestrian entry', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/f1000-series-flap-barrier.pdf' },
  { slug: 'flp-600lbs-feedback-lock', name: 'FLP 600LBS Feedback Lock', family: 'Access control', description: 'Flame-proof 600LBS feedback lock with door-status contact for demanding access-control environments.', image: '/products/flp-600lbs-feedback-lock/brochure-preview.png', images: ['/products/flp-600lbs-feedback-lock/brochure-preview.png'], authentication: 'Connected access system', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/flp-600lbs-feedback-lock.pdf' },
  { slug: 'flp-gs03', name: 'FLP GS03', family: 'Access control', description: 'Flame-proof glass-touch emergency switch with red-green door-status indication for hazardous-area access control.', image: '/products/flp-gs03/brochure-preview.png', images: ['/products/flp-gs03/brochure-preview.png'], authentication: 'Connected access system', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/flp-gs03.pdf' },
  { slug: 'gs03-go-stop-push-button', name: 'GS03 Go Stop Push Button', family: 'Access control', description: 'Stainless-steel go/stop push button with clear status indication for controlled door operation.', image: '/products/gs03-go-stop-push-button/brochure-preview.png', images: ['/products/gs03-go-stop-push-button/brochure-preview.png'], authentication: 'Connected access system', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/gs03-go-stop-push-button.pdf' },
  { slug: 'ind-300sb', name: 'IND 300SB', family: 'Entrance management', description: 'Single-lane swing barrier turnstile for smooth pedestrian entry after approved card or fingerprint authentication.', image: '/products/ind-300sb/brochure-preview.png', images: ['/products/ind-300sb/brochure-preview.png'], authentication: 'Connected access system', application: 'Pedestrian entry', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/ind-300sb.pdf' },
  { slug: 'stc-100', name: 'STC-100 Control Box', family: 'Access control', description: 'Compact control box for secure stacker-crane access with configurable relay outputs.', image: '/products/stc-100/brochure-preview.png', images: ['/products/stc-100/brochure-preview.png'], authentication: 'Connected controller', application: 'Personnel access', connectivity: 'Confirm configuration', deployment: 'Site assessment recommended', softwareCompatibility: 'Verify during solution design', status: 'Published portfolio', pdf: '/product-pdfs/stc-100.pdf' },
] as const;
