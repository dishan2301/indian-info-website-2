...
const pageEntries: readonly SearchEntry[] = [
  ...
  { title: 'Software integration reference', description: 'Brochure-backed interface facts and version-specific questions for technical review.', type: 'Technical', href: '/developers/integration-reference', keywords: 'API integration ERP payroll SAP architecture interface reference' },
