...
export const metadata: Metadata = { title: 'Industries | Indian Infotech', description: 'Explore workforce, access, and workplace operating contexts across industries.', alternates: { canonical: '/industries' } };
