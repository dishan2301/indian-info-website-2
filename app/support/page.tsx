...
export const metadata: Metadata = createPageMetadata({ title: 'Product & Software Support', description: 'Find Indian Infotech product, software, documentation, and technical support routes.', path: '/support' });
const cards = [
  ...
  ['Knowledge and FAQs', 'Use the Knowledge Center for published selection, integration, procurement, operating, trust, and support guidance.', 'Knowledge Center'],
