...
export const metadata: Metadata = createPageMetadata({
  ...
  description: 'Review the interface details that require version-specific technical confirmation before integration work begins.',
