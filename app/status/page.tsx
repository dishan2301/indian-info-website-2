...
export const metadata: Metadata = createPageMetadata({ title: 'System Status', description: 'Indian Infotech software service status and incident communication information.', path: '/status' });
