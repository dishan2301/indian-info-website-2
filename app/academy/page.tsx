...
export const metadata: Metadata = createPageMetadata({ title: 'Customer & Partner Academy', description: 'Customer, implementation, and partner learning paths for Indian Infotech workforce and access systems.', path: '/academy' });
