...
const corePortfolio = [
  ...
  { slug: 'easy-visit', category: 'Visitor operations', title: 'Easy Visit VMS', description: 'Cloud-based preregistration, approvals, secure check-in, visitor communication, dashboards, and visit records.', features: ['Email, WhatsApp and SMS invites', 'QR code and gate-pass check-in', 'Live notifications and dashboards'], href: '/software/visitor-management', alt: 'Visitor using QR check-in while a host approval workflow updates at a corporate reception', desktop: '/campaign/product-moments/visitor-management-v2.png', mobile: '/campaign/product-moments/visitor-management-v2.png' },
  ...
  { slug: 'entrance-control', category: 'Secure movement', title: 'Entrance Control', description: 'Flap barriers, tripod gates, full-height turnstiles, and boom barriers for people and vehicle entry points.', features: ['Emergency release options', 'SUS304 construction options', 'Third-party access integration'], href: '/products#entrance-management', alt: 'Pedestrian turnstiles, vehicle barrier, and security console working together at a campus entrance', desktop: '/campaign/product-moments/entrance-control-v2.png', mobile: '/campaign/product-moments/entrance-control-v2.png' },
  ...
  return <section className="core-portfolio core-portfolio-showcase" aria-labelledby="core-portfolio-heading" onFocusCapture={motion.pause} onBlurCapture={motion.resume}>
    ...
    <div className="core-system-stage">
      {corePortfolio.map((item, index) => <article className="core-system-poster" data-active={index === motion.active} aria-hidden={index !== motion.active} key={item.slug}>
        <Image className="art-desktop" src={'desktop' in item ? item.desktop : `/campaign/core-systems/${item.slug}-desktop-v2.webp`} alt={index === motion.active ? item.alt : ''} fill sizes="100vw" />
        <Image className="art-mobile" src={'mobile' in item ? item.mobile : `/campaign/core-systems/${item.slug}-mobile-v2.webp`} alt="" fill sizes="100vw" aria-hidden="true" />
...
const technologies: readonly (PosterMedia & { title: string; description: string; href: string })[] = [
  ...
  { title: 'Workforce workflows', description: 'Attendance events become useful when shifts, leave, review, and operational ownership connect.', href: '/software', desktop: '/campaign/product-moments/contract-workforce-v1.png', mobile: '/campaign/product-moments/contract-workforce-v1.png', alt: 'A supervisor coordinating contractor attendance at a manufacturing campus' },
];
