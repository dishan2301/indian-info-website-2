...
export function RoiCalculator() {
  ...
  return <section className="roi-calculator" aria-labelledby="roi-calculator-title">
    ...
    <div className="roi-result" aria-live="polite"><span>Illustrative estimate for a {estimate.employeeBand} workforce</span><strong>{estimate.savedHours} hours / month</strong><p>Potential administrative time avoided under the model assumptions, or approximately {estimate.annualHours} hours / year.</p><Link className="button button-primary" href={`/contact?topic=roi&employees=${employees}`}>Validate this estimate <span aria-hidden="true">↗</span></Link></div>
  </section>;
}
