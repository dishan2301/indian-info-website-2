...
const resources: readonly ResourceItem[] = [
  ...
  { title: 'Case study evidence brief', description: 'Collect the customer, challenge, baseline, solution, outcome, assets, metric method, and publication permission needed for an approved story.', type: 'Case study', area: 'Company', href: '/case-studies/brief', download: true },
